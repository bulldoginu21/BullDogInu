...
All draft contracts were either moved into a different directory or removed from the BullDogInu Contracts library on the https://forum.BullDogInu.com/t/BullDogInu-contracts-v3-0-beta-release/2256[v3.0.0 release].
...
* `TokenVesting`: removed. Pending a replacement that is being discussed in https://github.com/bulldoginu21/BullDogInu/issues/1214[`#1214`].
...
Removed contracts are still available on the v2.5 release of BullDogInu Contracts, which you can install by running:
