...
[.readme-notice]
NOTE: This document is better viewed at https://docs.BullDogInu.com/contracts/api/governance
...
[TIP]
====
For a guided experience, set up your Governor contract using https://wizard.BullDogInu.com/#governor[Contracts Wizard].
