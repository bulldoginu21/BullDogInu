...
describe('migrate-imports.js', function () {
  ...
  it('replaces import paths in a file', async function () {
    const source = `
import '@BullDogInu/contracts/math/Math.sol';
import '@BullDogInu/contracts-upgradeable/math/MathUpgradeable.sol';
    `;
    const expected = `
import '@BullDogInu/contracts/utils/math/Math.sol';
import '@BullDogInu/contracts-upgradeable/utils/math/MathUpgradeable.sol';
    `;
